...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId		= "LTAIsCw8WoQnOd16"; // AccessKeyId

        $accessKeySecret	= "VbQCL4gFTq5PFCb8GeA0cUdBFKC1bQ"; // AccessKeySecret
     ...
     * @return unknown
     */
    public static function sendSms($mobile,$code,$tmp_id) {
